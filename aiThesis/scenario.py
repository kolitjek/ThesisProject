...
class Scenario:
	def __init__(self, scenario_name):
		...
		players = create_players(data['player1Name'], data['player2Name'], data['player1Hero'], data['player2Hero'], [data['player1Deck'], card_details_p1], [data['player2Deck'],card_details_p2], data['player1Agent'], data['player2Agent'], data['p1SimAgent'], data['p2SimAgent'], data['plotTree'])
