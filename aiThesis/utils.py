...
class CMDInterface:
	def __init__(self):
		...
		self.parser.add_argument("-p1Class", metavar='p1Class', type=str, default="MAGE")
		self.parser.add_argument("-p2Class", metavar='p2Class', type=str, default="WARRIOR")
		...
		self.parser.add_argument("-mctsIterations",  nargs='*', default=None)
