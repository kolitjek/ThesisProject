...
def random_draft(card_class: CardClass, exclude=[]):
	"""
	Return a deck of
	30 random cards for the \a card_class
	"""
	from . import cards
...
def setup_game(player1=None, player2=None, scenario=None):
...
def play_scenario(scenario=None):
	game = setup_game(scenario.player1, scenario.player2, scenario)
	for player in game.players:
	...
	while game.turn < scenario.start_at_turn:
		scenario.skip_to_next_turn(game)

	scenario.setup_scenario(game)
...
def play_full_game(player1=None, player2=None):
